...
> 注意，删除租户的前提是，租户下的资源已被清除。建议在删除租户前，和租户相关管理人员沟通，确认不需要再使用云平台后，及时清理资源。如果租户不自主清理资源，可在管理后台，各个资源列表处，搜索到此租户的资源后进行删除。虚拟机、云硬盘、外网IP删除后会进入回收站，需要在回收站中彻底销毁以释放资源。# 8 审批管理
